...
public class Lab5Tester {
	...
	public static void testStackUseFunctions() {
		...
		resultString = reverseString("q");
		expected = "q";
		displayResults(resultString.equals(expected), "reverse single-length String");
		...
		resultString = reverseString("aBlUaA");
		expected = "AaUlBa";
		displayResults(resultString.equals(expected), "string with characters");
		...
		matched = doBracketsMatch("(((()))");
		displayResults(!matched, "doBracketsMatch all brackets");
