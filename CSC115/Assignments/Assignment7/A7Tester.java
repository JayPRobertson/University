...
public class A7Tester {
	...
	public static void testMixed() {
		...
		System.out.print("\nTOSTRING 252: "+pq.toString()+"\n");

		result = pq.removeMin();
		displayResults(result.equals(0), "inserts + remove");
		System.out.print("\nTOSTRING 254: "+pq.toString()+"\n");
		...
		result = pq.removeMin();
		System.out.println("line 271: "+result);
		displayResults(result.equals(1), "inserts + remove");
		
		result = pq.removeMin();
		System.out.println("line 273: "+result);
		displayResults(result.equals(2), "inserts + remove");
		
		result = pq.removeMin();
		System.out.println("line 275: "+result);
		displayResults(result.equals(3), "inserts + remove");
		
		result = pq.removeMin();
		System.out.println("line 277: "+result);
		displayResults(result.equals(4), "inserts + remove");

		pq.insert(1);
		System.out.print("\nTOSTRING 4: "+pq.toString()+"\n");
		result = pq.removeMin();
		System.out.println("line 281: "+result);
		displayResults(result.equals(1), "inserts + remove");
	...
	public static boolean testRandomArray (int count)
	{
		...
		*/
		...
		while (!q.isEmpty()) {
			...
			if (val < oldVal) {
				//System.out.println("VAL: "+ val+ " OLDVAL: "+oldVal+" I VAL: "+i);
				return false;
			}
			oldVal = val;
			i++;
	...
	public static boolean crying(int count){
		PriorityQueue<Integer> q = createNewPriorityQueue(Integer.class, count);
		System.out.println("Testing size: " + count);
		Random r = new Random();
		for (int i = 0; i < count; i++) {
	...
	public static void callCrying(){
		displayResults(crying(51), "I HATE THIS");
	}
