public class JobApplication implements Comparable<JobApplication> {
	...
	public int compareTo(JobApplication other) {
		if(this.priority == other.getPriority()){
			if(this.availableStartDate.compareTo(other.getAvailableStartDate())==0){
				return 0;
			}else{
				return this.availableStartDate.compareTo(other.getAvailableStartDate());
			}
		}else{
	...
	public boolean equals(JobApplication other) {
		return this.name.equals(other.getName()) && this.priority == other.getPriority();
	}
}
