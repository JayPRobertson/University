public class A4Tester {
	...
	public static void testBuildingsCount() {
		...
		List lempty = new ArrayList(empty);
		...
		result = A4Exercises.buildingsCount(lempty);
		expected = 0;
		displayResults(result == expected, "buildingsCount(lempty)");
		
		result = A4Exercises.buildingsCount(list4);
		expected = 2;
		displayResults(result == expected, "buildingsCount(list4)");
	...
	public static void testInhabitantsCount() {
		...
		Building b7 = new Building("Uptown Apartments", 4, 72);
		Building b8 = new Building("ECS", 6, 80);
		Building b9 = new Building("Empty Heights", 0, 0);
		...
		result = A4Exercises.inhabitantsCount(lempty);
		expected = 0;
		displayResults(result == expected, "inhabitantsCount(lempty)");

		result = A4Exercises.inhabitantsCount(list4);
		expected = 10+10;
		displayResults(result == expected, "inhabitantsCount(list4)");

		result = A4Exercises.inhabitantsCount(list5);
		expected = 0;
		displayResults(result == expected, "inhabitantsCount(list4)");

		result = A4Exercises.inhabitantsCount(list6);
		expected = 0+120;
		displayResults(result == expected, "inhabitantsCount(list4)");
	...
	public static void testDistanceAway() {
		...
		result = A4Exercises.distanceAway(lempty, b3);
		expected = -1;
		displayResults(result==expected, "distanceAway(lempty, b3)");

		result = A4Exercises.distanceAway(list2, b8);
		expected = -1;
		displayResults(result==expected, "distanceAway(list2, b8)");
	...
	public static void testDistanceToTallest() {
		...
		result = A4Exercises.distanceToTallest(lempty);
		expected = 0;
		displayResults(result==expected, "distanceToTallest(lempty)");
	...
	public static void testNumberVisible() {
		...
		result = A4Exercises.numberVisible(lempty);
		expected = 0;
		displayResults(result==expected, "numberVisible(lempty)");
	...
	public static void testStackIsGeneric() {
		...
		displayResults(s4.toString().equals("{}"), "Turn empty");		
		
		A4Stack<Integer> s5 = new A4Stack<Integer>();
		...
		displayResults(result5 ==null, "Empty");
