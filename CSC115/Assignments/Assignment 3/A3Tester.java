...
public class A3Tester {
	...
	public static void testAddFront() {
		...
		displayResults(result.equals("{}"), "testAddFront1");
		
		list1.addFront("A");
		result = list1.frontToBack();
		displayResults(result.equals("{A}"), "testAddFront2");
		
		list1.addFront("V");
		list1.addFront("A");
		list1.addFront("J");
		result = list1.frontToBack();
		displayResults(result.equals("{JAVA}"), "testAddFront3");
		result = list1.backToFront();
		displayResults(result.equals("{AVAJ}"), "testAddFront4");
	}
	...
	public static void testRemoveAt() {
		...
		result1 = list1.frontToBack();
		result2 = list1.backToFront();
		displayResults(result1.equals("{}"), "removeAt test5");
		displayResults(result2.equals("{}"), "removeAt test6");
