...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		result = A1Exercises.greatestCommonDenominator(7, 13);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(20, 5);
		expected = 5;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(19, 20);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(64, 80);
		expected = 16;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	}
	...
	public static void testCountMatches() {
		...
		System.out.println("Testing countMatches(arr1, 1)");
		result = A1Exercises.countMatches(arr4, 2);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing countMatches(arr5, 2)");
		result = A1Exercises.countMatches(arr5, 2);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
