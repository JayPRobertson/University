...
int main(int argc, char *argv[]) {
    ...
    t = strtok(line, " "); //gives array of all tokenized
    while (t) {
        num++;
        //create and reserve space in memory for new node
        list = add_inorder(list, new_node(t)); //for each element, add to list
        t = strtok(NULL, " ");
    }
